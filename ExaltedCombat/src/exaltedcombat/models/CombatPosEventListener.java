...
public interface CombatPosEventListener<EntityType> {
     ...
     *
     * @param entity the entity entering the combat. This arugment cannot be
     *   {@code null}.
    ...
    /**
     * Invoked when some entities are removed from the combat. The entites
     ...
     *
     * @param entities the non-empty collection of entites leaving the combat.
